...
import 'package:firebase/admin/laptop/add_laptop.dart';
import 'package:firebase/admin/laptop/update_laptop.dart';
...
class LaptopInsertDeleteUpdate extends StatefulWidget {
  const LaptopInsertDeleteUpdate({Key? key}) : super(key: key);

  @override
  State<LaptopInsertDeleteUpdate> createState() => _AdminDeleteUpdateState();
}

class _AdminDeleteUpdateState extends State<LaptopInsertDeleteUpdate> {
