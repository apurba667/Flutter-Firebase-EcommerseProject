...
class UpdateLaptop extends StatefulWidget {
  String? documentId;
  String? phoneName;
  String? phonePrice;
  String? phoneDes;
  String? phoneImg;
  UpdateLaptop(this.documentId, this.phoneName, this.phonePrice, this.phoneDes,
      this.phoneImg);

  @override
  State<UpdateLaptop> createState() => _UpdateLaptopState();
}

class _UpdateLaptopState extends State<UpdateLaptop> {
  ...
  updateData() async {
    if (_phoneImage == null) {
      ...
      UploadTask _uploadTask =
          _storage.ref("laptop").child(_phoneImage!.name).putFile(imageFile);
